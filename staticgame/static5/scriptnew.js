...
class Tree{
    ...
    run(tree){
        ...
        const arc = d3.arc()
                ...
                .outerRadius(d => Math.max(d.y0 * radius, d.y1 * radius - 0.5))// + Math.pow(1,d.depth-1)) //newcode
        ...
        const svg = d3.select('#partitionSVG')
                .style("font", "14px monospace") // key2   about the size of the label	
